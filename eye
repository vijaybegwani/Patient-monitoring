...
while True:
    ...
    # dark blue Color
    low_darkBlue = np.array([112, 150, 0])
    high_darkBlue = np.array([120, 255, 255])
    ...
    elif ((dist < 60)) and ((dist1 < 70)) and (len(eyes) > 0) :
